        ...
        <AnimatedPage direction={store.routePosition}>
            ...
            <SimpleGrid cols={isMobile ? 1 : 2}>
                ...
                <Stack>
                    ...
                    <TextInput disabled label="Courriel" size={isMobile ? "lg" : "md"} placeholder="Votre email"/>
                    <Textarea disabled label="Message" size={isMobile ? "lg" : "md"} placeholder="Votre message"/>
                    <Button size={isMobile ? "xl" : "lg"} disabled>⚠️ En construction</Button>
                </Stack>
            </SimpleGrid>
        </AnimatedPage>
    );
